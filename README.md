# Versatile Landing, Blog & Docs Template for a Simplified Web Presences

# Activar el back
Se debe ir a la carpeta /api ./vendor/bin/sail  up -d y luego prender el front pnpm run dev
