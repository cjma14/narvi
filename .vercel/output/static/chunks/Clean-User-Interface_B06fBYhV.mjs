...
const html = "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ultricies lacus non fermentum ultrices. Fusce consectetur le.</p>\n<p>Nam id eleifend dui, id iaculis purus. Etiam lobortis neque nec finibus sagittis. Nulla ligula nunc egestas ut.</p>";
				...
				const frontmatter = {"featureName":"Clean User Interface","title":"Solid Has Neat & Clean User Interface.","lightImg":"/images/features/features-light-01.png","darkImg":"/images/features/features-dark-01.svg"};
				const file = "/var/www/html/cepaonline/src/content/featureTab/Clean-User-Interface.md";
				const url = undefined;
				function rawContent() {
