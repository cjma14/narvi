import { a as createAstro, b as createComponent, d as renderTemplate, u as unescapeHTML, e as addAttribute, f as renderComponent, F as Fragment, m as maybeRenderHead, h as renderScript, g as renderSlot, i as renderHead } from './astro/server_CxlEycRW.mjs';
import 'kleur/colors';
...
const ogImageSrc = new Proxy({"src":"/_astro/social.CWnIx2-K.png","width":1200,"height":600,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/var/www/html/cepaonline/src/images/social.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/var/www/html/cepaonline/src/images/social.png");
							return target[name];
						}
					});
...
const faviconSvgSrc = new Proxy({"src":"/_astro/icon.CrCWjC4j.svg","width":512,"height":512,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/var/www/html/cepaonline/src/images/icon.svg";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/var/www/html/cepaonline/src/images/icon.svg");
							return target[name];
						}
					});
...
}, "/var/www/html/cepaonline/src/components/ui/forms/input/EmailInput.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/forms/input/PasswordInput.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/forms/input/Checkbox.astro", void 0);
...
const $$AuthBtn = createComponent(($$result, $$props, $$slots) => {
  ...
  const baseClasses = "inline-flex w-full items-center justify-center gap-x-2 rounded-lg px-4 py-3 text-sm font-bold text-white focus-visible:ring outline-none transition duration-300";
  const borderClasses = "border border-transparent";
  const bgColorClasses = "bg-primary-500 dark:focus:outline-none";
  const hoverClasses = "hover:bg-primary-400";
...
}, "/var/www/html/cepaonline/src/components/ui/buttons/AuthBtn.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/buttons/GoogleBtn.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/forms/LoginModal.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/forms/RegisterModal.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/forms/RecoverModal.astro", void 0);
...
const $$LoginBtn = createComponent(($$result, $$props, $$slots) => {
  ...
  const { title = "Iniciar sesi\xF3n" } = Astro2.props;
  ...
  const hoverClasses = "hover:text-primary-400 dark:hover:text-primary-300";
...
>
  ...
  {title}
</button> -->${maybeRenderHead()}<a type="button"${addAttribute(`${baseClasses} ${hoverClasses} ${darkClasses} ${mdClasses} ${txtSizeClasses}`, "class")} href="https://app.cepaonline.cl/login"> <!-- About Fragment: https://docs.astro.build/en/basics/astro-syntax/#fragments --> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(userSVG)}` })} ${title} </a>`;
}, "/var/www/html/cepaonline/src/components/ui/buttons/LoginBtn.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/sections/misc/Authentication.astro", void 0);
...
const $$BrandLogo = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<img src="/img/logo/logo_black" alt="cepa logo" class="w-16 md:w-28">`;
}, "/var/www/html/cepaonline/src/components/BrandLogo.astro", void 0);
...
}, "/var/www/html/cepaonline/src/components/ui/links/FooterSocialLink.astro", void 0);
...
const Icons = {
  ...
  house: {
    ...
    class: "h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:text-primary-400 dark:text-neutral-300 dark:hs-tab-active:text-primary-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  question: {
    ...
    class: "mt-1.5 h-6 w-6 flex-shrink-0 text-primary-600 dark:text-primary-400",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
...
}, "/var/www/html/cepaonline/src/components/ui/icons/Icon.astro", void 0);
...
</p> </div> <!-- Social Brands --> <div> ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.facebook }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "facebookFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.x }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "xFooter" })}` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.google }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "googleFooter" })} ` })} ${renderComponent($$result, "FooterSocialLink", $$FooterSocialLink, { "url": strings.socialLinks.slack }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "name": "slackFooter" })} ` })} </div> </div> ${renderScript($$result, "/var/www/html/cepaonline/src/components/sections/navbar&footer/FooterSection.astro?astro&type=script&index=0&lang.ts")} </div> </footer>`;
}, "/var/www/html/cepaonline/src/components/sections/navbar&footer/FooterSection.astro", void 0);
