const id = "9-simple-ways-to-improve-your-design-digital-product.md";
						const collection = "blogs";
						const slug = "9-simple-ways-to-improve-your-design-digital-product";
						...
						const data = {title:"9 simple ways to improve your design digital product.",date:new Date(1711909800000),category:"Blog",author:"John Doe",tags:["blog","business"],bannerImg:"/images/blog/blog-01.png",cardImg:"/images/blog/blog-01.png"};
						const _internal = {
							type: 'content',
							filePath: "/var/www/html/cepaonline/src/content/blogs/9-simple-ways-to-improve-your-design-digital-product.md",
							rawData: undefined,
						};
